...
* milk web
  * Scroll to top when short-cut-key s pressed
  * Select query strings on search box when focused
...
* etc
  * Fix TravisCI error
    ...
    * Add "gem update bundler" into .travis.yml

=== 1.8.7 2015/06/22

* milk web
  * Add :eliminate_extname attribute
